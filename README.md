...
Python package to parse Companies House accounts data in a streaming way. This also makes use of the [stream-unzip function](https://github.com/uktrade/stream-unzip)
<!-- --8<-- [end:intro] -->
